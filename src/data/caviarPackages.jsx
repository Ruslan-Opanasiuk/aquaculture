...
export const caviarCatalog = {
  ...
  forel: {
    ...
    longDescription: [
      "Ікра форелі вирізняється найдрібнішим серед лососевих зерном — близько 3 мм — насиченого червоного кольору і делікатною, майже прозорою оболонкою, яка легко розкривається на язиці. М’яка текстура і характерна легка гіркуватість формують смак, який багато поціновувачів називають найцікавішим серед червоних ікор.",
      "Вирощена в контрольованих умовах аквакультури, ця ікра відзначається стабільною якістю від партії до партії. Рівний насичений колір зерна і чистий смак без сторонніх нот — ознаки продукту, який однаково добре почувається і на святковому столі, і в буденній подачі."
    ],
  ...
  keta: {
    ...
    longDescription: [
      "Кета вирізняється великим добірним зерном — 6–8 мм — щільним, глянцевим, янтарно-жовтогарячого кольору з червонуватим відливом. Оболонка щільніша, ніж у горбуші, тому зерно тримає форму і не втрачає соковитості.",
      "Тонкий аромат і вишуканий смак з м’якою солоністю — саме за великі добірні ікринки цю ікру традиційно називають «царською». Через розмір зерна вона особливо ефектно виглядає у чистій подачі — на грінці чи в тарталетці, без додаткового декору."
    ],
    specs: "СКЛАД\nікра, сіль, масло, Е 200, Е 211.\nПерший сорт.\n\nТЕРМІН ПРИДАТНОСТІ\n12 місяців",
    images: {
  ...
  kizhuch: {
    ...
    longDescription: [
      "Кіжуч має щільне зерно 4–5 мм насичено-червоного кольору і виражену пружну оболонку, яка при розкушуванні дає характерний легкий «хрускіт». Смак глибший і трохи терпкіший, ніж у горбуші чи форелі.",
